...
const Createquestion = ({ history }) => {
    ...
    let [wrongAnswers, setWrongAnswers] = useState(
        [<WrongAnswerInput index="0" fields={fields} inputValue={fields.incorrect_answers[0]} handleInputChange={handleInputChange} />]
    );
    ...
    function handleInputChange (event, oldState) {
        // clearInterval(timer);
        // console.log('timer');
    ...
    const addMoreAnswers = (event) => {
        event.preventDefault();
        setWrongAnswers((oldAnswers) => oldAnswers.concat(<WrongAnswerInput index={oldAnswers.length} inputValue={fields.incorrect_answers[oldAnswers.length]} />))
    }
            ...
            <form onSubmit={handleSubmit} className="create-form">
                ...
                <div className="quiz-answers">
                    ...
                    {/* <textarea
                        ...
                        onChange={(e) => handleInputChange(e, fields)}
                    /> */}
                    <AddCircleIcon onClick={addMoreAnswers} />
                </div>
                {/* value={this.state.password} onChange={this.handleChange} /> */}
